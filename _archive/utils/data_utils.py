...
from hotplug import CALCULATED_MEAN, CALCULATED_STD
...
def read_vgg_dataset(dataset, idx, is_train):
    mean, std = CALCULATED_MEAN, CALCULATED_STD
    data_transforms = {
    ...
    if is_train:
        data_dir = f"{DATASET_BASE_PATH}/{idx}/train"
        data_transform = data_transforms['train']
    else:
        data_dir = f"{DATASET_BASE_PATH}/{idx}/test"
...
def read_client_data(dataset, idx, is_train=True):
    if 'vgg' in dataset:
        return read_vgg_dataset(dataset, idx, is_train)
