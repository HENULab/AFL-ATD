...
class FedALA(object):
    ...
    def train(self):
        ...
        plt.plot(range(i + 1), self.avg_test_acc)
        plt.xlabel('rounds')
    ...
    def send_models(self):
        ...
        for client in self.clients:
            ...
            """
            if client.id in range(self.num_clients - 20,self.num_clients - 3):  # 3 all
               client.local_initialization(self.global_model)
            else:
                continue
            """

            if (self.current_round != 0) and (self.current_round % 6 == 0):
                if client.id in range(self.num_clients - 20, self.num_clients - 3):
                    client.local_initialization(self.global_model)
                else:
                    continue
            else:
    ...
    def evaluate(self, acc=None, loss=None):
        ...
        self.avg_test_acc.append(test_acc)
